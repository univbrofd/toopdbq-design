...
```
design/ds-sync の DS を正として、UniverseView の地物ピン 3 タイプ（thumbnail / icon / threeD）の
...
HANDOFF: https://raw.githubusercontent.com/univbrofd/toopdbq/design/ds-sync/lib-design/handoff/TerrestrialPin/HANDOFF.md
