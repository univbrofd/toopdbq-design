...
(function () {
  ...
  let current = 'street';
  let activeCenter = CENTER;                 // moves as the user switches community focus
  function setCenter(c) { activeCenter = c; }
  ...
  function preset(name) {
    ...
    switch (name) {
      case 'region':
        return { center: C, zoom: L.regionZoom, pitch: 0,  bearing: 0, padding: { top: 0 } };
      case 'street':
        return { center: C, zoom: L.streetZoom, pitch: L.streetPitch, bearing: 0,
                 padding: { top: L.streetPadTop, bottom: 0, left: 0, right: 0 } };
      case 'globe':
      default:
        return { center: C, zoom: L.globeZoom, pitch: 0, bearing: 0, padding: { top: 0 } };
    }
  }
  ...
  window.EarthMap = { map, goPreset, reapplyPreset, setCenter, get current() { return current; }, get activeCenter() { return activeCenter; }, CENTER };
})();
